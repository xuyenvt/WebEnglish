    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7">
                ...
                <form action="{!! route('admin.catevideo.getAdd') !!}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{!! csrf_token() !!}"/>
                    <div class="form-group">
                        <label>Title - EN</label>
                        <input class="form-control" name="txtTitleEn" placeholder="Please Enter Title Category Video" value="{!! old('txtTitleEn') !!}"/>
                    </div>
                    <div class="form-group">
                        <label>Category Video Description</label>
                    ...
                    <button type="submit" class="btn btn-default">Category Video Add</button>
